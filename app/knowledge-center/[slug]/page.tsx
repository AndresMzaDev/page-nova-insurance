...
import knowledgeData from "../../../app/data/knowledge-center.json";
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: "If your vehicle is still operational and you're able to move it, pull over to a safe location away from traffic. Turn on your hazard lights to alert other drivers. If your vehicle cannot be moved, stay inside with your seatbelt fastened until help arrives, unless it's unsafe to do so.",
        },
        {
          heading: "Call the Police",
          content: "In South Carolina, you must report any accident that results in injury, death, or property damage exceeding $1,000. Even for minor accidents, having a police report can be invaluable when filing an insurance claim. The officer will document the scene, gather witness statements, and create an official record of the incident.",
        },
        {
          heading: "Document Everything",
          content: "Take photos and videos of the accident scene from multiple angles. Capture images of: vehicle damage, license plates, the surrounding area, traffic signs or signals, weather conditions, and any visible injuries. Also write down the time, date, location, and a detailed description of what happened while it's fresh in your memory.",
        },
        {
          heading: "Exchange Information",
          content: "Collect the following information from all parties involved: full name and contact information, driver's license number, insurance company and policy number, vehicle make, model, year, and license plate number. Also get contact information from any witnesses who saw the accident occur.",
        },
        {
          heading: "Contact Your Insurance Company",
          content: "Notify your insurance company as soon as possible, ideally within 24 hours of the accident. Provide them with all the information you've gathered. Your insurance agent will guide you through the claims process and explain what coverage applies to your situation. Be honest and thorough when describing the accident.",
        },
        {
      ...
      sections: [
        {
          ...
          content: "Los momentos inmediatamente posteriores a un accidente de auto pueden ser abrumadores. Tu primera prioridad debe ser mantener la calma y evaluar si alguien está lesionado. Si hay lesiones graves, llama al 911 inmediatamente. Incluso si el accidente parece menor, es importante permanecer en la escena hasta que hayas intercambiado información con el otro conductor.",
        },
        {
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: "The type of vehicle you drive significantly impacts your insurance costs. Sports cars, luxury vehicles, and vehicles with high theft rates cost more to insure. Before purchasing a vehicle, research its insurance costs. Safer vehicles with good crash test ratings and anti-theft features often qualify for lower premiums.",
        },
        {
          heading: "Review and Adjust Coverage",
          content: "If you have an older vehicle, consider dropping collision and comprehensive coverage if the vehicle's value is low. The cost of these coverages may exceed the vehicle's worth. However, always maintain adequate liability coverage as it's required by law and protects your assets. Regularly review your coverage needs as your situation changes.",
        },
        {
          heading: "Improve Your Credit Score",
          content: "In most states, including South Carolina, insurance companies use credit-based insurance scores to determine rates. Improving your credit score can lead to lower premiums. Pay bills on time, reduce debt, and monitor your credit report regularly. Even small improvements in your credit score can result in meaningful premium reductions.",
        },
        {
          heading: "Shop Around Regularly",
          content: "Insurance rates vary significantly between companies. Get quotes from multiple insurers at least once a year, especially when your policy renews. Don't automatically renew without comparing. Online comparison tools make it easy to compare rates. However, remember that the cheapest option isn't always the best - consider coverage, customer service, and claims handling reputation.",
        },
      ],
    },
    es: {
      ...
      sections: [
        {
          ...
          content: "Tu historial de conducción es uno de los factores más significativos que afectan tus tarifas de seguro. Las violaciones de tráfico, accidentes y condenas por DUI pueden aumentar dramáticamente tus primas. Enfócate en prácticas de conducción segura: obedece los límites de velocidad, evita distracciones, nunca conduzcas bajo la influencia y sigue todas las leyes de tráfico. Muchos aseguradores ofrecen descuentos de conductor seguro por mantener un registro limpio con el tiempo.",
        },
        {
          heading: "Aumenta Tus Deducibles",
          content: "Elegir un deducible más alto puede reducir significativamente tu prima mensual. Si tienes un deducible de $500 y lo aumentas a $1,000, podrías ahorrar 15-30% en tu prima. Sin embargo, asegúrate de poder pagar el deducible más alto si necesitas presentar un reclamo. Esta estrategia funciona mejor si eres un conductor seguro con un buen fondo de emergencia.",
        },
        {
          heading: "Agrupa Tus Pólizas",
          content: "La mayoría de las compañías de seguros ofrecen descuentos de múltiples pólizas cuando agrupas auto, hogar y otras pólizas de seguro juntas. Esto puede ahorrarte 10-25% en tus costos totales de seguro. Además, mantener todas las pólizas con la misma compañía simplifica la gestión y a menudo proporciona un mejor servicio al cliente.",
        },
        {
          heading: "Aprovecha los Descuentos",
          content: "Pregunta a tu asegurador sobre descuentos disponibles: descuentos de buen estudiante para conductores jóvenes con buenas calificaciones, finalización de curso de conducción defensiva, descuentos de bajo kilometraje si conduces menos que el promedio, instalación de dispositivos anti-robo, y descuentos de lealtad para clientes a largo plazo. Muchas personas no se dan cuenta de que califican para múltiples descuentos simultáneamente.",
        },
        {
          heading: "Elige Tu Vehículo Sabiamente",
          content: "El tipo de vehículo que conduces impacta significativamente tus costos de seguro. Los autos deportivos, vehículos de lujo y vehículos con altas tasas de robo cuestan más asegurar. Antes de comprar un vehículo, investiga sus costos de seguro. Los vehículos más seguros con buenas calificaciones de pruebas de choque y características anti-robo a menudo califican para primas más bajas.",
        },
        {
          heading: "Revisa y Ajusta la Cobertura",
          content: "Si tienes un vehículo más antiguo, considera eliminar la cobertura de colisión e integral si el valor del vehículo es bajo. El costo de estas coberturas puede exceder el valor del vehículo. Sin embargo, siempre mantén una cobertura de responsabilidad adecuada ya que es requerida por ley y protege tus activos. Revisa regularmente tus necesidades de cobertura a medida que tu situación cambia.",
        },
        {
          heading: "Mejora Tu Puntuación de Crédito",
          content: "En la mayoría de los estados, incluyendo Carolina del Sur, las compañías de seguros usan puntuaciones de seguro basadas en crédito para determinar las tarifas. Mejorar tu puntuación de crédito puede llevar a primas más bajas. Paga las facturas a tiempo, reduce la deuda y monitorea tu informe de crédito regularmente. Incluso pequeñas mejoras en tu puntuación de crédito pueden resultar en reducciones significativas de primas.",
        },
        {
          heading: "Compara Regularmente",
          content: "Las tarifas de seguro varían significativamente entre compañías. Obtén cotizaciones de múltiples aseguradores al menos una vez al año, especialmente cuando tu póliza se renueva. No renueves automáticamente sin comparar. Las herramientas de comparación en línea facilitan comparar tarifas. Sin embargo, recuerda que la opción más barata no siempre es la mejor - considera la cobertura, el servicio al cliente y la reputación de manejo de reclamos.",
        },
      ],
    },
  },
      ...
      sections: [
        {
          ...
          content: "Liability insurance is required by law in South Carolina and most states. It covers bodily injury and property damage you cause to others in an accident. This includes medical expenses, lost wages, pain and suffering, and vehicle repairs for the other party. South Carolina requires minimum limits of 25/50/25, meaning $25,000 per person for bodily injury, $50,000 per accident for bodily injury, and $25,000 for property damage. However, these minimums may not be sufficient for serious accidents.",
        },
        {
          heading: "Collision Coverage",
          content: "Collision coverage pays for damage to your vehicle resulting from a collision with another vehicle or object, regardless of who's at fault. This coverage is optional but highly recommended, especially if you have a loan or lease on your vehicle. Your lender typically requires collision coverage. The coverage amount is based on your vehicle's actual cash value, minus your deductible.",
        },
        {
          heading: "Comprehensive Coverage",
          content: "Comprehensive coverage protects your vehicle from non-collision incidents such as theft, vandalism, fire, natural disasters, falling objects, and animal collisions. Like collision coverage, it's optional but often required by lenders. Comprehensive coverage is particularly valuable if you live in areas prone to severe weather, theft, or if you park your vehicle in areas with high crime rates.",
        },
        {
          heading: "Uninsured/Underinsured Motorist Coverage",
          content: "This coverage protects you if you're hit by a driver who has no insurance or insufficient insurance to cover your damages. In South Carolina, uninsured motorist coverage is required, but you can reject it in writing. However, this is generally not recommended as it provides important protection. Underinsured motorist coverage kicks in when the at-fault driver's limits are too low to cover all your expenses.",
        },
        {
          heading: "Medical Payments Coverage",
          content: "Medical payments coverage (MedPay) pays for medical expenses for you and your passengers regardless of who's at fault. It covers hospital visits, doctor bills, surgery, X-rays, and other medical costs. This coverage is optional in South Carolina but can be valuable, especially if you don't have health insurance or have high health insurance deductibles.",
        },
        {
          heading: "Personal Injury Protection (PIP)",
          content: "PIP is similar to MedPay but more comprehensive. It covers medical expenses, lost wages, and sometimes funeral expenses. PIP is required in some states but optional in South Carolina. It provides broader coverage than MedPay and can be particularly beneficial if you're unable to work due to accident-related injuries.",
        },
      ],
    },
    es: {
      ...
      sections: [
        {
          ...
          content: "Notifica a tu compañía de seguros lo antes posible después de un accidente o incidente. La mayoría de los aseguradores tienen líneas directas de reclamos 24/7. Cuanto antes reportes, más rápido puede comenzar el proceso de reclamos. Ten tu número de póliza listo cuando llames. Tu agente de seguros te guiará a través del proceso y explicará qué información y documentación necesitarás.",
        },
        {
          heading: "Recopila la Documentación Requerida",
          content: "Necesitarás proporcionar: fotos y videos de los daños, reporte policial (si aplica), información de contacto de todas las partes involucradas, declaraciones de testigos, registros médicos (si hay lesiones), estimaciones de reparación de talleres automotrices, y cualquier otra documentación relevante. Cuanto más exhaustiva sea tu documentación, más fluido será tu proceso de reclamo.",
        },
        {
          heading: "Entiende Tu Cobertura",
          content: "Revisa tu póliza para entender qué está cubierto y cuáles son tus deducibles. Tu ajustador de seguros explicará qué coberturas se aplican a tu reclamo. Ten en cuenta que necesitarás pagar tu deducible antes de que tu seguro cubra los costos restantes. Algunas coberturas pueden tener límites o exclusiones específicas.",
        },
        {
          heading: "Trabaja con un Ajustador",
          content: "Se te asignará un ajustador de seguros para evaluar tu reclamo. Inspeccionarán los daños, revisarán tu documentación y determinarán el valor del reclamo. Sé cooperativo y proporciona toda la información solicitada prontamente. También puedes contratar un ajustador público si no estás de acuerdo con la evaluación de la compañía de seguros, aunque esto conlleva costos adicionales.",
        },
        {
          heading: "Obtén Estimaciones de Reparación",
          content: "Tu compañía de seguros puede requerir que obtengas estimaciones de múltiples talleres de reparación, o pueden tener talleres preferidos. Compara estimaciones y asegúrate de que sean exhaustivas. Algunos aseguradores tienen programas de reparación directa donde trabajan directamente con talleres, lo que puede agilizar el proceso. Asegúrate de que cualquier taller que elijas sea reputado y certificado.",
        },
        {
          heading: "Revisa la Oferta de Liquidación",
          content: "Una vez que tu reclamo sea evaluado, recibirás una oferta de liquidación. Revísala cuidadosamente para asegurar que cubra todos los daños y gastos. Si crees que la oferta es demasiado baja, puedes negociar o disputarla. Mantén registros detallados de todas las comunicaciones y prepárate para proporcionar documentación adicional si es necesario.",
        },
        {
          heading: "Haz Seguimiento Regularmente",
          content: "Mantén contacto regular con tu ajustador de reclamos y haz seguimiento del estado de tu reclamo. Mantén un registro de todas las conversaciones, correos electrónicos y correspondencia. Si hay retrasos o problemas, no dudes en escalar a un supervisor o presentar una queja con el departamento de seguros de tu estado si es necesario.",
        },
      ],
    },
  },
      ...
      sections: [
        {
          ...
          content: "Your driving history is one of the most significant factors. Accidents, traffic violations, and DUI convictions can dramatically increase premiums. Insurance companies view drivers with clean records as lower risk. Maintaining a clean driving record over time can lead to significant savings through safe driver discounts.",
        },
        {
          heading: "Age and Experience",
          content: "Younger drivers, especially those under 25, typically pay higher premiums due to lack of experience and higher accident rates. Drivers over 65 may also see increases. Middle-aged drivers with good records usually pay the lowest rates. Some insurers offer discounts for completing driver education courses.",
        },
        {
          heading: "Location",
          content: "Where you live significantly impacts your rates. Urban areas with higher traffic density, crime rates, and accident frequencies typically have higher premiums. Rural areas generally have lower rates. Your specific ZIP code matters, as insurers use local data to assess risk. Moving to a safer area can reduce your premiums.",
        },
        {
          heading: "Vehicle Type",
          content: "Sports cars, luxury vehicles, and vehicles with high theft rates cost more to insure. Safe, reliable vehicles with good crash test ratings often qualify for discounts. The cost to repair or replace your vehicle also affects premiums. Before buying a vehicle, research its insurance costs.",
        },
        {
          heading: "Coverage Amounts and Deductibles",
          content: "Higher coverage limits mean higher premiums, but they provide better protection. Higher deductibles lower premiums but increase out-of-pocket costs when filing claims. Finding the right balance is key. Consider your assets and risk tolerance when choosing coverage levels.",
        },
        {
          heading: "Credit Score",
          content: "In South Carolina and most states, insurers use credit-based insurance scores. Studies show a correlation between credit scores and claim likelihood. Improving your credit score can lead to lower premiums. Pay bills on time, reduce debt, and monitor your credit report regularly.",
        },
        {
          heading: "Annual Mileage",
          content: "The more you drive, the higher your risk of accidents. Low-mileage drivers often qualify for discounts. If you work from home or have a short commute, you may save money. Some insurers offer usage-based insurance programs that track your driving and adjust rates accordingly.",
        },
        {
          heading: "Claims History",
          content: "Frequent claims can increase your premiums, as insurers view you as higher risk. Some companies offer accident forgiveness programs for long-term customers with good records. Consider whether filing small claims is worth potential premium increases.",
        },
      ],
    },
    es: {
      ...
      sections: [
        {
          ...
          content: "Tu historial de conducción es uno de los factores más significativos. Los accidentes, violaciones de tráfico y condenas por DUI pueden aumentar dramáticamente las primas. Las compañías de seguros ven a los conductores con registros limpios como de menor riesgo. Mantener un historial de conducción limpio con el tiempo puede llevar a ahorros significativos a través de descuentos de conductor seguro.",
        },
        {
          heading: "Edad y Experiencia",
          content: "Los conductores más jóvenes, especialmente aquellos menores de 25, típicamente pagan primas más altas debido a la falta de experiencia y tasas de accidentes más altas. Los conductores mayores de 65 también pueden ver aumentos. Los conductores de mediana edad con buenos registros usualmente pagan las tarifas más bajas. Algunos aseguradores ofrecen descuentos por completar cursos de educación para conductores.",
        },
        {
          heading: "Ubicación",
          content: "Dónde vives impacta significativamente tus tarifas. Las áreas urbanas con mayor densidad de tráfico, tasas de criminalidad y frecuencias de accidentes típicamente tienen primas más altas. Las áreas rurales generalmente tienen tarifas más bajas. Tu código postal específico importa, ya que los aseguradores usan datos locales para evaluar el riesgo. Mudarse a un área más segura puede reducir tus primas.",
        },
        {
          heading: "Tipo de Vehículo",
          content: "Los autos deportivos, vehículos de lujo y vehículos con altas tasas de robo cuestan más asegurar. Los vehículos seguros y confiables con buenas calificaciones de pruebas de choque a menudo califican para descuentos. El costo de reparar o reemplazar tu vehículo también afecta las primas. Antes de comprar un vehículo, investiga sus costos de seguro.",
        },
        {
          heading: "Montos de Cobertura y Deducibles",
          content: "Límites de cobertura más altos significan primas más altas, pero proporcionan mejor protección. Deducibles más altos reducen las primas pero aumentan los costos de bolsillo al presentar reclamos. Encontrar el equilibrio correcto es clave. Considera tus activos y tolerancia al riesgo al elegir niveles de cobertura.",
        },
        {
          heading: "Puntuación de Crédito",
          content: "En Carolina del Sur y la mayoría de los estados, los aseguradores usan puntuaciones de seguro basadas en crédito. Los estudios muestran una correlación entre las puntuaciones de crédito y la probabilidad de reclamos. Mejorar tu puntuación de crédito puede llevar a primas más bajas. Paga las facturas a tiempo, reduce la deuda y monitorea tu informe de crédito regularmente.",
        },
        {
          heading: "Kilometraje Anual",
          content: "Cuanto más conduces, mayor es tu riesgo de accidentes. Los conductores de bajo kilometraje a menudo califican para descuentos. Si trabajas desde casa o tienes un viaje corto al trabajo, puedes ahorrar dinero. Algunos aseguradores ofrecen programas de seguro basados en uso que rastrean tu conducción y ajustan las tarifas en consecuencia.",
        },
        {
          heading: "Historial de Reclamos",
          content: "Los reclamos frecuentes pueden aumentar tus primas, ya que los aseguradores te ven como de mayor riesgo. Algunas compañías ofrecen programas de perdón de accidentes para clientes a largo plazo con buenos registros. Considera si presentar reclamos pequeños vale la pena los aumentos potenciales de primas.",
        },
      ],
    },
  },
      ...
      sections: [
        {
          ...
          content: "Teen drivers are statistically the highest-risk group on the road. According to the CDC, drivers aged 16-19 are three times more likely to be involved in a fatal crash than drivers 20 and older. This increased risk translates to higher insurance premiums. Insurance companies base rates on actuarial data showing teens have more accidents, violations, and claims than experienced drivers.",
        },
        {
        ...
        },
        {
          ...
          content: "Most insurers offer good student discounts for teens who maintain a B average or better. This can save 10-25% on the teen's portion of the premium. To qualify, your teen typically needs to provide a transcript or report card showing their grades. This discount rewards responsible behavior and academic achievement.",
        },
        {
          heading: "Driver Education Discounts",
          content: "Completing a state-approved driver education course can result in significant discounts. Some insurers offer discounts for both classroom and behind-the-wheel training. These courses teach safe driving practices and can reduce premiums by 10-15%. Keep certificates of completion to provide to your insurer.",
        },
        {
          heading: "Safe Driving Monitoring",
          content: "Some insurers offer telematics programs that monitor driving behavior through a mobile app or device. Safe driving habits like obeying speed limits, avoiding hard braking, and limiting nighttime driving can earn discounts. These programs can be particularly beneficial for teens who demonstrate responsible driving.",
        },
        {
          heading: "Vehicle Choice Matters",
          content: "The vehicle your teen drives significantly impacts insurance costs. Avoid high-performance, sports, or luxury vehicles. Instead, choose safe, reliable vehicles with good crash test ratings and safety features. Older, less expensive vehicles often have lower insurance costs, though you'll want to ensure they have modern safety features.",
        },
        {
          heading: "Graduated Driver Licensing",
          content: "South Carolina's Graduated Driver Licensing (GDL) program has restrictions for teen drivers that can affect insurance. Understanding these restrictions and ensuring your teen follows them is important. Some insurers offer discounts for teens who complete GDL requirements without violations.",
        },
      ],
    },
    es: {
...
export default function TopicPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const content = topicContent[slug] || topicContent["what-to-do-after-car-accident"];
      ...
      <article className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            {(language === "en" ? content.en.sections : content.es.sections).map(
